...
# annotations
plot!(annotate=(start_week, 1600, text("über 65-Jährige", :left, 10)))
plot!(annotate=(start_week, 450, text("0 bis 64-Jährige", :left, 10)))

plot!(annotate=(start_week-3, 4550, text("Sterbefälle in Österreich 2019/2020", :left, 12)))
...
run(`convert -density 120 sterbefaelle_at.pdf sterbefaelle_at.png`)
